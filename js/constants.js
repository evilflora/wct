...
WF.CATEGORY = {
  ...
  atagraph:         { name: "atagraph",        label: "Atagraph"          , description: "???" },     
  ...
  chest:            { name: "chest",           label: "Chests"            , description: "Arsenal / Warframe / Appearance / Attachments / Chest" },
  ...
  pet_cosmetic:     { name: "pet_cosmetic",    label: "Pet Cosmetics"     , description: "Arsenal / Companion / Appearance" },
  ...
  skin:             { name: "skin",            label: "Skins (WIP)"       , description: "Arsenal / Warframe / Appearance / Skin" },
...
WF.TYPES = {
  ...
  pet_cosmetic:       { kubrow: "kubrow", kavat: "kavat"},
  pet_cosmetic_type:  { fur_color: "Fur Color", fur_pattern: "Fur Pattern", armor: "Armor", collar: "Collars" },
  ...
  skin:               { skin: "Skin", helmet: "Helmet", animation: "Animation", wing: "Wings", mask: "Mask", tail: "Tail", plate: "Plates", guard: "Guard", armor: "Armor", holster: "Holster", sleeve: "Sleeves", legging: "Leggings", hood: "Hood", ink: "Ink", oculus: "Oculus", pauldron: "Pauldrons", suit: "Suit", greaves: "Greaves" },
...
WF.FILTERS = {
  ...
  pet_cosmetic: [
    { field: "pet_cosmetic_type", options: WF.TYPES.pet_cosmetic_type },
  ],
  mod: [
...
WF.NAV_GROUPS = [
  ...
  {
    label: "Warframe Customization",
    types: [WF.CATEGORY.skin_helmet, WF.CATEGORY.chest, WF.CATEGORY.color_palette, WF.CATEGORY.ephemera, WF.CATEGORY.emblem, WF.CATEGORY.sigil, WF.CATEGORY.signa, WF.CATEGORY.skin,WF.CATEGORY.syandana],
  },
  {
    label: "Weapon Customization",
    types: [WF.CATEGORY.skin_weapon, WF.CATEGORY.sugatra],
  },
  {
    label: "Pet Customization",
    types: [WF.CATEGORY.pet_cosmetic],
  },
  {
  ...
  {
    label: "Other Customization",
    types: [WF.CATEGORY.emote, WF.CATEGORY.glyph],
  },
  {
    label: "Decorations",
    types: [WF.CATEGORY.arcade, WF.CATEGORY.articula, WF.CATEGORY.domestik, WF.CATEGORY.floof, WF.CATEGORY.poster, WF.CATEGORY.trophy, WF.CATEGORY.ship_decoration],
  },
];
