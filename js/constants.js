...
WF.TYPES = {
  ...
  enemy:              { grineer: "Grineer", corpus: "Corpus", infestation: "Infestation", unaffiliated: "Unaffiliated", orokin: "Orokin", sentient: "Sentient", stalker: "Stalker", narmer: "Narmer", murmur: "The Murmur", scaldra: "Scaldra", techrot: "Techrot", anarchs: "Anarchs" },
  ephemera:           { vengeful: "Vengeful", sister: "Sisters", coda: "Coda", aspirus: "Aspirus", atramentum: "Atramentum", body: "Body", conquera: "Conquera", constellation: "Constellations", baro: "Baro Ki'Teer", oneoff: "One-Offs", easter: "Easter", halloween: "Halloween", summer: "Summer", valentine: "Valentines", winter: "Winter", shard: "Shard", step: "Step", zariman: "Zariman", market: "Market Only"},
...
WF.NAV_GROUPS = [
  ...
  {
    label: "Codex",
    types: [WF.CATEGORY.arcane, WF.CATEGORY.artgallery, WF.CATEGORY.enemy, WF.CATEGORY.fragment, WF.CATEGORY.mod, WF.CATEGORY.quest, WF.CATEGORY.relic],
  },
  {
    label: "Upgrade",
  ...
  {
    label: "Collectible",
    types: [WF.CATEGORY.airsupport, WF.CATEGORY.armament, WF.CATEGORY.scene, WF.CATEGORY.framefighter, WF.CATEGORY.gear, WF.CATEGORY.helminth, WF.CATEGORY.peelypix, WF.CATEGORY.resource, WF.CATEGORY.simulacrum, WF.CATEGORY.somachord],
  },
  {
    label: "Appearance",
